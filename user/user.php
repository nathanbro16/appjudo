	...
	<div style="padding-bottom:2%; ">
		<div class="card" >
			<div class="card-body row">
				<h5 class="col" style="margin-bottom:0;"><span id="bonjour">Bonjour</span>, <?= $userinfo->getname();?> <?= $userinfo->getsurname();?>. Il est <span class="badge badge-secondary" id='heure' ></span></h5>
				<h5 class="col"></h5>
				<h5 class="col text-right" style="margin-bottom:0;"> <img src="../grade/<?= $jugrd['html']?>.png" width="60" height="30" class="d-inline-block align-top" alt=""> / <?= $jugrd['name']?> / <?=$user->getnameyear()?></h5>
			</div>
		</div>
